...
android {
    namespace = "com.theholylabs.foodiex"
    ...
    defaultConfig {
        ...
        applicationId = "com.theholylabs.foodiex"
        minSdkVersion(26)
        targetSdk = flutter.targetSdkVersion
        versionCode = 60 // 🔁 Increase this by 1 for each new build
        versionName = "1.60"  // 🆕 This is your human-readable version
    }
